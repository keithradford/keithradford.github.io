        ...
        <HStack>
          ...
          <VStack color="whitesmoke" w="75%">
            <Text>
              ...
              interest in making tools to help others whether they're students,
              developers, and more. I'm from Victoria, BC and currently studying
              ...
              skiing, and video games among other things. <br />
              <br />
              Check me out on the various networks linked below, take a look at
              my <Link color="#EE495A">resume</Link>, send me an email at{" "}
              <Link color="#EE495A" href="mailto:khr8771@gmail.com">
                khr8771@gmail.com
              </Link>
